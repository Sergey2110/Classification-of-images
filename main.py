...
def initial():
    global train_transform, valid_transform, data_df
    ...
    set_transform(train_transform, valid_transform)
...
def generate_dataset():
    global train_transform, valid_transform, data_df, train_loader, valid_loader, train_df, valid_df
...
def evaluation_model():
    global valid_loader, model, valid_df, test_df, valid_transform, test_loader
